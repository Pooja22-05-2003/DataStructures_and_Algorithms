...
void printSumK(int ind , int arr[] , int n, vector<int> & ds ,int k , int currSum){
    ...
    currSum+=arr[ind];
    printSumK(ind+1 , arr, n , ds ,k, currSum);
    // not take
    ds.pop_back();  
...
int main(){
    ...
    vector<int> ds;
    cout<<"Printing all the subsequences having: "<<endl;
    print(0,arr,n,ds);
...
1
Printing all the subsequences having:
1 2 1
1 2
1 1
1
